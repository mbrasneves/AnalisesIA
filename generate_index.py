#!/usr/bin/env python3
"""
Gera o index.html do repositório AnalisesIA automaticamente.
Lê todos os ficheiros analise-*.html, extrai os meta tags de indexação
...
if __name__ == '__main__':
    ...
    html = build_index(analyses)
    Path('index.html').write_text(html, encoding='utf-8')
    print(f"index.html gerado com {len(analyses)} análise(s).")
